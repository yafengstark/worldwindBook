...
public interface Globe extends WWObject, Extent
{
     ...
     *                         from which elevations are drawn. (To compute radians from a distance, divide the distance// 除
     *                         by the radius(半径） of the globe, ensuring that both the distance and the radius are in the
     *                         same units.)
